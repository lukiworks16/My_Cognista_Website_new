...
const CourseDetailPage: React.FC<CourseDetailPageProps> = ({ courseId, onBack, onOpenPopup }) => {
  ...
  const courseData = {
    ...
    'master-data-science': {
      ...
      image: 'https://www.gyansetu.in/wp-content/uploads/2024/02/FUqHEVVUsAAbZB0-1024x580-1.jpg?auto=compress&cs=tinysrgb&w=1200',
      price: '₹34,999',
    ...
    'full-stack-python': {
      ...
      image: 'https://imarticus.org/blog/wp-content/uploads/2024/02/Master-Python-Programming-with-this-Comprehensive-Guide-Imarticus.jpg?auto=compress&cs=tinysrgb&w=1200',
      price: '₹29,999',
    ...
    'machine-learning': {
      ...
      icon: Brain,
      color: 'from-purple-500 to-pink-500',
      image: 'https://xiengineering.com/wp-content/uploads/2023/10/AdobeStock_519767884-1-scaled.jpeg?auto=compress&cs=tinysrgb&w=1200',
      price: '₹29,999',
    ...
    'deep-learning': {
      ...
      icon: Brain,
      color: 'from-purple-500 to-pink-500',
      image: 'https://blogs-images.forbes.com/bernardmarr/files/2018/10/AdobeStock_179912599-1-1200x797.jpeg?auto=compress&cs=tinysrgb&w=1200',
      price: '₹29,999',
      originalPrice: '₹59,999,00',
      rating: 4.9,
      students: '1,200+',
    ...
    'business-intelligence': {
      ...
      icon: BarChart,
      color: 'from-blue-500 to-cyan-500',
      image: 'https://images.squarespace-cdn.com/content/v1/559929f0e4b0e9cbf62bbbb4/1641827953410-M2LZ1F4CBHEU4URUYRGX/AdobeStock_447703909.jpeg?auto=compress&cs=tinysrgb&w=1200',
      price: '₹24,999',
    ...
    'tableau': {
      ...
      image: 'https://miro.medium.com/1*3rt9Poxf3YgAIJCfA1am1w.jpeg?auto=compress&cs=tinysrgb&w=1200',
      price: '₹21,999',
    ...
    'power-bi': {
      ...
      image: 'https://5.imimg.com/data5/FV/EQ/GZ/SELLER-22985683/img-20200609-114003-487.jpg?auto=compress&cs=tinysrgb&w=1200',
      price: '₹21,999',
      originalPrice: '₹44,999,00',
      rating: 4.8,
      students: '2,200+',
