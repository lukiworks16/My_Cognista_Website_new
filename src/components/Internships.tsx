...
const Internships: React.FC<InternshipsProps> = ({ onOpenPopup }) => {
  ...
  const internshipPrograms = [
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpg?auto=compress&cs=tinysrgb&w=400',
    ...
    },
    {
      ...
      category: 'cloud',
      image: 'https://images.pexels.com/photos/1181298/pexels-photo-1181298.jpg?auto=compress&cs=tinysrgb&w=400',
      description: 'Work with AWS, Azure, and Google Cloud platforms to build scalable cloud solutions.',
      requirements: ['Basic Programming', 'Linux', 'Networking', 'Cloud Fundamentals'],
      benefits: ['Cloud certification prep', 'DevOps exposure', 'Infrastructure knowledge', 'Industry connections'],
  ...
  const categories = [
    ...
    { id: 'cloud', name: 'Cloud Computing', count: internshipPrograms.filter(p => p.category === 'cloud').length },
